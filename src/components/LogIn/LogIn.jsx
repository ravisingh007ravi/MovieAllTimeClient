...
export default function LogIn() {
  ...
  return (
    <div className="min-h-screen sm:pt-25 md:pt-25 bg-[#0f0f0f] bg-opacity-90 bg-[url('https://res.cloudinary.com/dnpn8ljki/image/upload/v1748723343/captain_america_brave_new_world_ver2_qgl4de.jpg')] bg-cover bg-center bg-blend-overlay flex items-center justify-center p-4 sm:p-6">
      <motion.form
